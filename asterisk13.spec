...
menuselect/menuselect --enable-category MENUSELECT_ADDONS --enable res_pktccops --enable chan_mgcp --enable res_http_post --enable chan_motif --disable chan_mobile --enable app_meetme --enable app_page --enable res_snmp --enable res_srtp --enable DONT_OPTIMIZE --disable BUILD_NATIVE --enable res_statsd --enable res_chan_stats --enable res_endpoint_stats --enable codec_opus --enable codec_silk --enable codec_siren7 --enable codec_siren14 --enable CORE-SOUNDS-EN-WAV --enable CORE-SOUNDS-EN-SLN16 --enable CORE-SOUNDS-EN_AU-WAV --enable CORE-SOUNDS-EN_AU-SLN16 --enable CORE-SOUNDS-EN_GB-WAV --enable CORE-SOUNDS-EN_GB-SLN16 --enable CORE-SOUNDS-ES-WAV --enable CORE-SOUNDS-ES-G722 --enable CORE-SOUNDS-ES-SLN16 --enable CORE-SOUNDS-FR-WAV --enable CORE-SOUNDS-FR-SLN16 --enable CORE-SOUNDS-IT-WAV --enable CORE-SOUNDS-IT-SLN16 --enable CORE-SOUNDS-RU-WAV --enable CORE-SOUNDS-RU-SLN16 --enable CORE-SOUNDS-JA-WAV --enable CORE-SOUNDS-JA-SLN16 --enable CORE-SOUNDS-SV-WAV --enable CORE-SOUNDS-SV-SLN16 --enable EXTRA-SOUNDS-EN-WAV --enable EXTRA-SOUNDS-EN-SLN16 --enable EXTRA-SOUNDS-EN_GB-WAV --enable EXTRA-SOUNDS-EN_GB-SLN16 --enable EXTRA-SOUNDS-FR-WAV --enable EXTRA-SOUNDS-FR-SLN16 --enable MOH-OPSOUND-WAV --enable MOH-OPSOUND-SLN16  menuselect.makeopts
...
/var/lib/asterisk/moh/.asterisk-moh-opsound-sln16-2.03
